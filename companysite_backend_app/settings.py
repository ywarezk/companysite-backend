...
SECRET_KEY = 'q6qk-pq%+ayga@xw$5qczp08ob4u5tt0_lfgs$zjngmn5qwiot'
...
ROOT_URLCONF = 'companysite_backend_app.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'companysite_backend_app.wsgi.application'
